...
urlpatterns=[
    ...
    # Profile (self – HR / Manager / Employee)
    path('profile/', views.manage_profile, name='my_profile'),

    # Admin edit any employee by ID
    path('profile/<int:emp_id>/', views.manage_profile, name='admin_edit_profile'),
